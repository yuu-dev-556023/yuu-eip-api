...
try {
    ...
    #         $OutputPath = ".\Migrations\CeosHr"
    #     }
    #     "2" {
    #         $ContextName = "ReportDataDbContext"
    #         $OutputPath = ".\Migrations\ReportData"
    #     }
    #     default {
    ...
    # 構建 dotnet ef migrations add 指令
    ...
    Write-Host "`n遷移添加成功！" -ForegroundColor Green
}
catch {
